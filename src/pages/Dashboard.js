  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" / " >
        ...
        <span class="ms-1 font-weight-bold">MintCode</span>
      </a>
    </div>
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link " href="/aboutsection">
            ...
            <span class="nav-link-text ms-1">About Section</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="/titlesection">
            <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
              <i class="ni ni-app text-info text-sm opacity-10"></i>
            </div>
            <span class="nav-link-text ms-1">Title Edit</span>
          </a>
        </li>
